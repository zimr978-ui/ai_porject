...
year_df = pd.DataFrame({
    ...
    "Rate": [9.8, 10.5, 11.7, 13.1, 14.2, 15.1]
...
ax2.set_title("Youth Obesity Trend")
...
st.info(
    ...
    "📈 최근 청소년 비만률은 꾸준히 증가하는 추세를 보이고 있어요."
...
future_df = pd.DataFrame({
    ...
    "Year": [2023, future_year],

    "Rate": [15.1, prediction]
...
ax3.set_title("Youth Obesity Forecast")
...
st.warning(
    ...
    "⚠️ 예측 결과는 단순 선형 추세를 기반으로 한 참고용 결과입니다."
